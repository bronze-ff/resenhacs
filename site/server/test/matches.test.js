...
describe('GET /api/matches/:id', () => {
  ...
  it('devolve placar, rounds, highlights, clipes e armas por jogador', async () => {
    const { app } = appWith([
      ...
      ['from match_players mp', [{ steam_id64: '765', nick: 'fih', team: 'A', kills: 25, team_kills: 1, deaths: 10, assists: 5, headshot_kills: 12, damage: 2500, rounds_played: 22, rating: '1.35', kast_pct: '72.5', won: true, is_tracked: true, avatar_url: 'https://avatars.steamstatic.com/fih.jpg' }]],
    ...
    expect(res.status).toBe(200)
    expect(res.body.players[0]).toMatchObject({ nick: 'fih', rating: 1.35, kastPct: 72.5, isTracked: true, teamKills: 1, avatarUrl: 'https://avatars.steamstatic.com/fih.jpg' })
